  ...
  module Core
    module Models
      ...
      class PageNumberModel < BaseModel
        ...
        attr_reader :page_number_label_2
        ...
        def label_2(value)
          @page_number_label_2 = value.to_s.strip   # renderer will enforce trailing space
        end
        ...
        def option_keys
          [:align, :label, :label_2, :label_size, :number_size, :show]
        end
